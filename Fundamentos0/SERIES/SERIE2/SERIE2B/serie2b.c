...
/*Este programa compara dos cadenas, sin importar las mayusculas o minusculas dentro de este*/
...
/* Está función compara dos arreglos para evaluar si, estos dos son inguales.
*@param arr1: arreglo tipo caracter; primera cadena para convertir en minsculas.
*@param arr2: arreglo tipo caracter ;segunda cadena para convertir en minusculas.
